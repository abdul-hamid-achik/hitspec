...
<Columns cols={2}>
  ...
  <Card title="Full Test Framework" icon="flask-vial">
    20+ assertion operators, variable captures, request dependencies, retries, and more.
  </Card>
...
<Columns cols={2}>
  <Card title="Assertions" icon="check">
    20 operators including `==`, `contains`, `matches`, `exists`, `type`, `schema`, `snapshot`, and more.
  </Card>
