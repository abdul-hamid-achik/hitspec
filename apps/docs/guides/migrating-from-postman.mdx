---
title: "Migrate from Postman to hitspec .http tests"
description: "Import Postman collections into hitspec and convert them to plain-text .http files. Covers the import process and the key differences from Postman."
keywords:
  - "postman to hitspec"
  - "migrate postman"
  - "import postman collection"
  - "postman alternative"
  - "postman to http file"
---
