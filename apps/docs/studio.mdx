---
title: "hitspec studio — a keyboard-first terminal API client"
description: "hitspec studio is a keyboard-first terminal UI for .http files — edit, run, and inspect requests with a tabbed viewer, plus stress, mock, record, and history."
keywords:
  - "hitspec studio"
  - "terminal api client"
  - "tui api testing"
