---
title: "The .http file format for API tests"
description: "Anatomy of a hitspec .http file: requests, headers, bodies, variables, assertions, captures, dependencies, and directives — plain text you can diff and commit."
keywords:
  - "http file format"
  - "hitspec syntax"
  - "api test file"
