---
title: "Write and run your first API test in under a minute"
description: "Write a plain-text .http file with requests, assertions, and captures, then run it with hitspec. A fast first API test you can read, diff, and commit."
keywords:
  - "hitspec quickstart"
  - "first api test"
  - "http file tutorial"
