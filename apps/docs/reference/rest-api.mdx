...
Partially update the server configuration. Only provided fields are updated; omitted fields remain unchanged.
...
Sent every 500ms during an active stress test with current metrics.
