---
title: "Database assertions after HTTP requests"
description: "Verify database state after HTTP requests with SQL queries and assertions. Use >>>db blocks to check side effects in PostgreSQL, MySQL, and SQLite."
keywords:
  - "database assertions"
