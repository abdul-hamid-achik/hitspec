---
title: "Mock server from .http files"
description: "Start a mock HTTP server from your .http test files for frontend development and integration testing — no separate mock tool or fixtures to maintain."
keywords:
  - "mock server"
  - "api mocking"
  - "mock http server"
