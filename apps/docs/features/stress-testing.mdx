---
title: "Load and stress test APIs with hitspec"
description: "Load test APIs with hitspec — configurable rate, virtual users, ramp-up, and pass/fail thresholds. No separate tool; export metrics to Prometheus or Datadog."
keywords:
  - "api stress testing"
  - "api load testing"
  - "hitspec stress"
